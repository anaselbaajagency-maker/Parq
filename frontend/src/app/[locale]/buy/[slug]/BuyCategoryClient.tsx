...
export default function BuyCategoryClient({ categoryId, citySlug, category }: Props) {
    ...
    useEffect(() => {
        ...
        if (selectedCity) {
            result = result.filter((l: any) => l.city_id === selectedCity || l.location === selectedCity);
            count++;
        }
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <div className={styles.headerSection}>
                <Link href={routes.buy()} className={styles.backLink}>
                    <ArrowLeft size={20} strokeWidth={1.5} />
                    <span>Back to buy categories</span>
                </Link>
            </div>
            */}
